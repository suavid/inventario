...
<div class="page secondary with-sidebar">
    ...
    <div class="page-sidebar">
        <ul>
            ...
            <li class="sticker sticker-color-pink dropdown active" data-role="dropdown">
                <a><i class="icon-list"></i> To Do dropdown</a>
            ...
            <li class="sticker sticker-color-orange dropdown active" data-role="dropdown">
                <a><i class="icon-list"></i> List opened</a>
    ...
    &lt;/div&gt;
                ...
                <h2>Second level menu Dropdown opened menu</h2>
                <p>
                    You can add <code>keep-opened</code> class to sub-menu to prevent default collapsing of menu.
                </p>
                <pre class="prettyprint linenums">
    &lt;div class="page-sidebar"&gt;
        &lt;ul&gt;
