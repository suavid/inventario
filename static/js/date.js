...
jQuery.datePicker = function() {
    ...
    var _getCalendarDiv = function(dIn) {
        ...
        jCalDiv.append(jQuery("<div></div>").attr('class', 'link-close').append(closeLink), jQuery("<h3></h3>").html(months[d.getMonth()] + ' ' + d.getFullYear()));
        ...
        if (jQuery.browser.msie) {
            var iframe = ['<iframe class="bgiframe" tabindex="-1" src="blank.html" ', 'style="display:block; position:absolute;', 'top: 0;', 'left:0;', 'z-index:-1; filter:Alpha(Opacity=\'0\');', 'width:3000px;', 'height:3000px"/>'].join('');
    ...
    return{getChooseDateStr: function() {
            return navLinks.b
        }, show: function() {
            if (_openCal) {
                _closeDatePicker()
