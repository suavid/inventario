    ...
    with (this) {
            ...
            setEnumProvider("country", new EnumProvider({
                ...
                getOptionValuesForEdit: function(grid, column, rowIndex) {
                    ...
                    if (continent == "eu")
                        ...
                        return {"br": "Brazil", "ca": "Canada", "us": "USA"};
                    else if (continent == "af")
                        return {"ng": "Nigeria", "za": "South Africa", "zw": "Zimbabwe"};
                    return null;
                }
            }));
        }
        ...
        setCellRenderer("country", new CellRenderer({
            render: function(cell, value) {
                cell.innerHTML = value ? "<img src='" + image("flags/" + value.toLowerCase() + ".png") + "' alt='" + value + "'/>" : "";
            }
        }));
        ...
        addCellValidator("age", new CellValidator({
            isValid: function(value) {
                return value == "" || (parseInt(value) >= 16 && parseInt(value) < 100);
            }
        }));
        ...
        modelChanged = function(rowIndex, columnIndex, oldValue, newValue, row) {
            ...
            if (this.getColumnName(columnIndex) == "continent")
                this.setValueAt(rowIndex, this.getColumnIndex("country"), ""); // if we changed the continent, reset the country
            this.renderCharts();
        };
        ...
        $("#barcount").val(maxBars).change(function() {
            editableGrid.maxBars = $("#barcount").val();
