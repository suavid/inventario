...
// p�gina y otra mediante GET y POST. Mediante esta
// clase se suple la carencia que hay en PHP de hacer
// un env�o de datos por POST de manera natural.
//
// Puedes darle cualquier uso a esta clase siempre y
// cuando seas respetuoso de los derechos de autor�a
...
class Request {
     ...
     * La clave no puede ser num�rica.
     *
     * @param string $key
     * @param string $value
     */
    function addParam($key, $value) {
        if (is_numeric($key)) {
            throw new Exception("El nombre del parametro no puede ser numérico.");
        }
    ...
    /**
     * Ejecuta el env�o de parametros a la p�gina especificada
     * en el parametro 'url'.
     *
     * @param string $url
     * @param bool $execute
