...
function getParameter($key) {
    ...
    $value = ($value != NULL) ? $value : (isset($_GET[$key]) ? $_GET[$key] : NULL);
...
class GridServerHandler {
    ...
    function exportPDF($orientation = "P", $pageFormats = "A4", $baseImgPath = '', $header = '') {
        $this->exportFileName = $this->getExportFileName();
        $this->exportHTML2PDF($orientation, $pageFormats, $baseImgPath, $header);
    }
